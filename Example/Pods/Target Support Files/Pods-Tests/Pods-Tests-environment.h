...
// DRTabBarController
#define COCOAPODS_POD_AVAILABLE_DRTabBarController
#define COCOAPODS_VERSION_MAJOR_DRTabBarController 0
#define COCOAPODS_VERSION_MINOR_DRTabBarController 1
#define COCOAPODS_VERSION_PATCH_DRTabBarController 0
